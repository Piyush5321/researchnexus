...
class GraphLiveController {
  ...
  syncInspectorDrawer(nodeData) {
    const drawer = document.getElementById('inspection-drawer') || document.getElementById('inspectorDrawer');
    if (!drawer) return;

    drawer.classList.add('active');

    // Populate data fields
    const titleEl = document.getElementById('inspect-title') || document.getElementById('inspectorTitle');
    const deptEl = document.getElementById('inspect-dept') || document.getElementById('inspectorDept');
    const authorEl = document.getElementById('inspect-author') || document.getElementById('inspectorAuthor');
    const typeEl = document.getElementById('inspect-type') || document.getElementById('inspectorType');
    const doiEl = document.getElementById('inspect-doi');
    const abstractEl = document.getElementById('inspect-abstract') || document.getElementById('inspectorAbstract');
    const matchBarEl = document.getElementById('inspect-ast-bar') || document.getElementById('inspectorMatchBar');
    const matchLabelEl = document.getElementById('inspect-ast-label') || document.getElementById('inspectorScoreText');
    ...
    if (doiEl) doiEl.textContent = nodeData.doi || 'DOI: 10.1145/nexus.2024.01';
    ...
    if (matchBarEl) {
      ...
      if (matchLabelEl) matchLabelEl.textContent = `${matchPct}% AST Verification Match`;
    }
  }

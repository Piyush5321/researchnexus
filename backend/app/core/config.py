...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = "postgresql+asyncpg://nexus_admin:NexusSecurePass2026!@127.0.0.1:5432/research_nexus"
    SYNC_DATABASE_URL: str = "postgresql://nexus_admin:NexusSecurePass2026!@127.0.0.1:5432/research_nexus"
    DB_POOL_SIZE: int = 20
    ...
    # Security & Auth
    SECRET_KEY: str = "super-secret-jwt-signing-key-research-nexus-2026-secure-token"
    ALGORITHM: str = "HS256"
